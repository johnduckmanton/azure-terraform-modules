...
variable "public_subnets_service_endpoints" {
  description = "The list of Service endpoints to associate with the public subnets."
  default = [
...
variable "private_subnets_service_endpoints" {
  description = "The list of Service endpoints to associate with the private subnets."
  default = [
    "Microsoft.AzureActiveDirectory",
    "Microsoft.AzureCosmosDB",
    "Microsoft.CognitiveServices",
...
variable "aci_subnets_service_endpoints" {
  description = "The list of Service endpoints to associate with the ACI subnets."
  default = [
    "Microsoft.AzureActiveDirectory",
    "Microsoft.AzureCosmosDB",
    "Microsoft.CognitiveServices",
...
variable "fl_network_watcher_rg_name" {
  description = "Network Watcher resource group name for flow logs"
}
